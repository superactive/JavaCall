...
public class CThostFtdcMarketDataExchangeField {
  ...
  public CThostFtdcMarketDataExchangeField(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(CThostFtdcMarketDataExchangeField obj) {
  ...
  public void setExchangeID(double value) {
