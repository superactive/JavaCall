...
public class CThostFtdcQueryMaxOrderVolumeWithPriceField {
  ...
  public CThostFtdcQueryMaxOrderVolumeWithPriceField(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(CThostFtdcQueryMaxOrderVolumeWithPriceField obj) {
