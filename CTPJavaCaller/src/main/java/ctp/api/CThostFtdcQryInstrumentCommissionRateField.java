...
public class CThostFtdcQryInstrumentCommissionRateField {
  ...
  public CThostFtdcQryInstrumentCommissionRateField(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(CThostFtdcQryInstrumentCommissionRateField obj) {
