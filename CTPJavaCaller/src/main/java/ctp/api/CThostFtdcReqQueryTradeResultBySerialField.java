...
public class CThostFtdcReqQueryTradeResultBySerialField {
  ...
  public CThostFtdcReqQueryTradeResultBySerialField(long cPtr, boolean cMemoryOwn) {
    swigCMemOwn = cMemoryOwn;
    swigCPtr = cPtr;
  }

  public static long getCPtr(CThostFtdcReqQueryTradeResultBySerialField obj) {
